    ...
    <div class="login">
      ...
      <div class="login-bottom clearfix">
        ...
        <div class="login-input fl">
          <input type="text" class="zhanghao"  value="86775657"><i class="fa fa-angle-down" style="margin: 0 4px"></i><span>注册账号</span><br>
          <input type="password" class="mima" value="ujoeufoe"><i class="fa fa-keyboard-o" style="top: -5px;"></i><span>找回密码</span>
        </div>
